...
`recode()` was created to help with the task of recoding the markers so that they reflect a the "typical representation". This helps the user track the origin of the haplotypes in the F~2~. **Essential for genetic mapping.**  The function is quite flexible and its main functionality is:
...
```{r filtering comparison, fig.height=4.3, fig.width=8.0, message=FALSE, warning=FALSE}
v <- plot_genotype_histogram(het_phased_geno_1629_filt) +
  ggtitle("Homo + filtered het markers")
