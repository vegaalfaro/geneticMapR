...
![Flat x Cylindrical table beet cross. Image credit. Dr. Maddy Oravec](../man/figures/flatxcyl.png) 
...
If you need help in this step, check the `bcftools_tutorial` in my github [vegaalfaro/bcftoolsR](https://github.com/vegaalfaro/bcftoolsR). Still under development. 
